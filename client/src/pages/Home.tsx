      ...
      <main>
        <section className="brief-hero">
          ...
          <div className="brief-hero-copy brief-reveal">
            ...
            <p>A working client brief that brings together Optimum’s approved visual system, September content strategy, production requirements, and website recovery decision.</p>
          ...
          <div className="brief-hero-visual brief-reveal delay-1">
            ...
            <div className="brief-cover-card"><span>PROJECT STATUS · 01</span><h2>1 content strategy.<br />1 brand system.<br />1 domain decision.</h2><div><b>SEP 2026</b><b>CLIENT REVIEW</b></div></div>
        ...
        <section className="brief-architecture">
          <div className="brief-architecture-copy brief-reveal"><SectionLabel number="02" label="Content architecture" /><h2>The mix<br /><em>does the work.</em></h2><p>Education earns trust at the top of the funnel. Proof, treatment clarity, and clinician presence progressively reduce the uncertainty around booking.</p></div>
        ...
        <section className="brief-domain" id="domain">
          <div className="brief-domain-head brief-reveal"><SectionLabel number="05" label="Website, domain & security status" /><h2>Recovery before<br /><em>testing.</em></h2><p>The website condition audit establishes a clear operational sequence: first clarify or restore the public domain; then build and verify the live website; only then can the authorised security-testing stage meaningfully proceed.</p></div>
        ...
        <section className="brief-measurement">
          <div className="brief-measurement-copy brief-reveal"><SectionLabel number="06" label="Measurement framework" /><h2>Measure the<br /><em>right progress.</em></h2></div>
        ...
        <section className="brief-schedule">
          <div className="brief-schedule-stage">
            ...
            <div className="brief-schedule-copy brief-reveal"><SectionLabel number="07" label="After approval" /><h2>Ready to put<br />the plan <em>on set?</em></h2><p>Once the content strategy, production requirements, and project direction are approved, choose a Shoot Meet with Machfold to plan the capture day.</p><div className="brief-schedule-meta"><span><b>120 MIN</b> SHOOT MEET</span><i /><span><b>MACHFOLD</b> VIA CAL.COM</span></div></div>
        ...
        <section className="brief-handoff"><div className="brief-handoff-orb" /><div className="brief-handoff-copy brief-reveal"><span className="brief-eyebrow"><ClipboardCheck size={14} /> Closing brief</span><h2>One content strategy.<br />One website decision.<br /><em>One clear path forward.</em></h2><p>Review the content strategy, confirm production inputs, and resolve the domain decision before the next build and authorised testing stages.</p></div><div className="brief-handoff-card brief-reveal delay-1"><span>NEXT CLIENT ACTIONS</span><ol><li><b>01</b> Approve content strategy and production requirements.</li><li><b>02</b> Confirm domain ownership or approve repurchase/reconfiguration.</li><li><b>03</b> Provide clinic details, booking route, and consented assets.</li></ol><a href="/brand-system">View the preserved Brand System <ExternalLink size={15} /></a></div></section>
      </main>
